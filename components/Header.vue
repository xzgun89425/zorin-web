...
<template>
  <div class="w-full flex justify-between bg-white items-center text-sm index-font px-5 lg:px-20 py-2 text-gray-500">
    <div class="flex items-center gap-2">
      ...
      </svg>eel012345@yahoo.com.tw
    </div>
    <div class="flex items-center gap-3 pr-4">
      <a href="https://www.facebook.com/"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 mt-1"
          viewBox="0 0 448 512">
          <path
            d="M400 32H48A48 48 0 0 0 0 80v352a48 48 0 0 0 48 48h137.25V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.27c-30.81 0-40.42 19.12-40.42 38.73V256h68.78l-11 71.69h-57.78V480H400a48 48 0 0 0 48-48V80a48 48 0 0 0-48-48z" />
        </svg></a>
      <a href="https://www.instagram.com/"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 mt-1"
          viewBox="0 0 448 512">
          <path
      ...
      <a href="https://line.me/zh-hant/"><svg xmlns="http://www.w3.org/2000/svg" class="w-5 mt-1"
  ...
  <div
    ...
    <div>
      <NuxtLink to="/">
        <h3 class="text-2xl md:text-4xl lg:text-5xl tracking-widest Pacifica font-medium">Zorin Audio</h3>
