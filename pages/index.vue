      ...
      <ContainerDiv :title="'header.contact'">
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-10 py-16 max-w-7xl w-full">
          ...
          <div class="col-span-1 flex flex-col items-center rounded-md p-6 relative">
            ...
            <h1 class="text-base tracking-wider flex items-center index-font mt-8">{{ $t("taiwan")
            }}：eel012345@yahoo.com.tw</h1>
            <h1 class="text-base tracking-wider flex items-center index-font"> {{ $t("overseas") }}：ivan450870@gmail.com
            </h1>
          </div>
          <div class="col-span-1 flex flex-col items-center rounded-md p-6 relative ">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 fill-primary"
            ...
            <h1 class="text-base tracking-wider flex justify-start items-center index-font mt-8">{{ $t("taiwan")
            }}：0919515222</h1>
            <h1 class="text-base tracking-wider flex justify-start items-center index-font"> {{ $t("overseas")
            }}：+886968998665
            </h1>
          </div>
          <div class="col-span-1 flex flex-col items-center rounded-md p-6 relative">
            ...
            <a href="https://line.me/ti/p/mmn3F3EX4U"
              class="text-base tracking-wider index-font hover:cursor-pointer hover:text-blue-500 duration-200">{{
                $t("overseas")
              }}：0968998665
            </a>
          </div>
